...
tmux new-window -t $N:100 -n 'mininet' "sudo ./topo.py --method central --topo randomhaha"
sleep 1

OFP_PORT=$((6733))
WSAPI_PORT=$((8733))
tmux new-window -t $N:1 -n "ctrl" "TOPO_INPUT=randomhaha ryu-manager --ofp-tcp-listen-port $OFP_PORT --use-stderr ./central_ctrl.py"
