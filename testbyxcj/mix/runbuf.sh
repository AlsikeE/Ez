...
tmux send-keys -t $N:1 "LOCAL_ID=1 BUF_SIZE=100 REDIS_PORT=6379 ryu-manager --verbose --ofp-tcp-listen-port 6667 localthread.py" Enter
...
tmux send-keys -t $N:2 "LOCAL_ID=2 BUF_SIZE=100 REDIS_PORT=6380 ryu-manager --verbose --ofp-tcp-listen-port 6668 localthread.py" Enter
sleep 2
