...
tmux send-keys -t $N:1 "LOCAL_ID=0 ryu-manager --verbose --ofp-tcp-listen-port 6666 localthread.py" Enter

tmux new-window -t $N:2 -n "controller1" 
tmux send-keys -t $N:2 "LOCAL_ID=1 ryu-manager --verbose --ofp-tcp-listen-port 6667 local2.py" Enter
sleep 2
