...
mxd ="abcsdfasdfasdfasdd"
# print("weight:")
# print(len(binascii.hexlify(mxd)))
...
# encaped=packet.packet.serialize(pmxd)
# print(len(encaped))
...
# encaped_mxd=u.serialize(pmxd,i)
# print(len(encaped_mxd))
empty=bytearray()
encaped_without_mxd=u.serialize(empty,i)
print(len(encaped_without_mxd))

print("=========adfasdfa===============")
# print(dir(ipv4.ipv4))
# i = ipv4.ipv4(src=1,dst=2,proto=IPPROTO_UDP,total_length=ipv4.ipv4._MIN_LEN + len(encaped_mxd))
...
a = pickle.dumps(b'jason') + pickle.dumps(b'ha')
